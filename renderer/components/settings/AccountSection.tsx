  ...
  const handleAvatarFileChange = async (
    ...
    try {
      ...
      if (result.success) {
        ...
        window.api.showNotification(
          "Upload failed",
          result.error ?? "Could not upload avatar."
        );
      }
    } catch {
      setAvatarPreview(null);
              ...
              {editing ? (
                ...
                <div className="divide-y divide-gray-800">
                  ...
                  <div className="flex items-center justify-between px-4 py-2.5 gap-4">
                    ...
                    <span
                      className={`text-2xs font-medium px-2 py-0.5 border rounded-full ${roleBadge.cls}`}
                    >
                      {roleBadge.label}
                    </span>
                  </div>
            ...
            <div className="max-w-3xl">
              <div className="bg-gray-900 border border-gray-800 rounded-md p-8 text-center">
                ...
                <p className="text-xs text-gray-600 mt-1">
                  Complete onboarding to manage workspaces.
                </p>
              </div>
            </div>
          ))}
