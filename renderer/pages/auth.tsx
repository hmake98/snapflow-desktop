          ...
          <div className="flex-1 flex items-center justify-center overflow-hidden bg-slate-950 px-6">
            <div className="w-full max-w-[360px]">
              ...
              <button
                ...
                className="mt-3 w-full flex items-center justify-center gap-3 bg-gray-800 hover:bg-gray-700 active:bg-gray-900 disabled:opacity-50 text-gray-100 font-medium py-2.5 rounded-lg transition-all duration-200 text-sm border border-gray-700"
              >
                <svg
                  className="w-4 h-4 flex-shrink-0"
                  viewBox="0 0 24 24"
