              ...
              <div className="p-6 max-w-3xl space-y-3">
                ...
                <div className="bg-gray-800/40 border border-gray-700/50 rounded-lg overflow-hidden">
                  <div className="flex items-center gap-3 px-4 py-2.5 border-b border-gray-700/40">
                    ...
                    <span className="text-sm font-semibold text-gray-400 uppercase tracking-wide">GitHub</span>
                    <span className="text-sm text-gray-600 font-normal normal-case tracking-normal">Sync snaps as issues to a repository</span>
                  </div>
                  <div className="p-4">
                    <GitHubConnectorManager />
                  </div>
                ...
                <div className="bg-gray-800/40 border border-gray-700/50 rounded-lg overflow-hidden">
                  <div className="flex items-center gap-3 px-4 py-2.5 border-b border-gray-700/40">
                    ...
                    <span className="text-sm font-semibold text-gray-400 uppercase tracking-wide">Zoho Projects</span>
                    <span className="text-sm text-gray-600 font-normal normal-case tracking-normal">Sync snaps as tasks to a Zoho project</span>
                  </div>
                  <div className="p-4">
                    <ZohoConnectorManager />
                  </div>
